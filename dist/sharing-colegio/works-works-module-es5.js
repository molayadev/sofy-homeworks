...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["works-works-module"], {
  ...
  /***/
  function srcAppSharedServicesFirestoreServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    console.log('Before');
                    _context.next = 4;
                    return this.item.weeks;

                  case 4:
                    this.weeks = _context.sent;
                    console.log('After', this.weeks);

                  case 6:
                    return _context.abrupt("return", this.weeks);
    ...
    FirestoreService.ɵfac = function FirestoreService_Factory(t) {
      return new (t || FirestoreService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"]));
    };
  ...
  /***/
  function srcAppWorksComponentsPagePageComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _shared_services_firestore_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../../../shared/services/firestore.service */
    "./src/app/shared/services/firestore.service.ts");
    /* harmony import */
    ...
    var _angular_material_extensions_pages__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! @angular-material-extensions/pages */
    "./node_modules/@angular-material-extensions/pages/__ivy_ngcc__/fesm2015/angular-material-extensions-pages.js");
    /* harmony import */
    ...
    var _shared_components_card_trabajo_card_trabajo_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ../../../shared/components/card-trabajo/card-trabajo.component */
    "./src/app/shared/components/card-trabajo/card-trabajo.component.ts");

    function PageComponent_mat_page_loader_35_div_6_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function PageComponent_mat_page_loader_35_div_7_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function PageComponent_mat_page_loader_35_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function PageComponent_mat_card_44_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](4, " Continuar\xE1... ");
    ...
    var PageComponent = /*#__PURE__*/function () {
      function PageComponent(sanitizer, firestore, router, route) {
      ...
      _createClass(PageComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.firestore.getData().subscribe(function (data) {
            _this.works = _toConsumableArray(data.works);
            _this.weeks = data.weeks;
            _this.defaultAvatarImg = data.avatarImg ? data.avatarImg : 'https://api.adorable.io/avatars/90/ubicapo.png';

            var avatarImg = _this.sanitizer.bypassSecurityTrustResourceUrl(_this.defaultAvatarImg);
            ...
            _this.subjects = _toConsumableArray(data.subjects);
            console.log('SUBJECTS: ', _this.subjects, _this.showBySubject);
            var byWeek = data.weeks.map(function (element) {
              var week = element.id;

              var dataWeeks = _this.getWorksByWeek(week);
            ...
            console.log('BY WEEK: ', byWeek, _this.showBySubject);

            var bySubject = _this.subjects.map(function (element) {
              var subject = element;

              var dataSubject = _this.getWorksBySubject(subject);
            ...
            console.log('BY WEEK: ', bySubject, _this.showBySubject);
            _this.toShow = {
              byWeek: byWeek,
              bySubject: bySubject
            };
            console.log(_this.item, '.asda.asdasdadsasdasd');
          });
        }
      }, {
        key: "getFilteredSections",
        value: function getFilteredSections() {
          if (this.showBySubject) {
            return this.subjects;
          }

          return this.weeks.map(function (obj) {
            return obj.text;
          });
        }
      }, {
        key: "getFilteredWorks",
        value: function getFilteredWorks(index) {
          if (this.showBySubject) {
        ...
        key: "getWeekTitle",
        value: function getWeekTitle(id) {
          return this.weeks.filter(function (week) {
            return week.id === id;
          })[0].text;
        }
      }, {
        ...
        key: "getWorksBySubject",
        value: function getWorksBySubject(subject) {
          var _this2 = this;

          return this.works.filter(function (work) {
            return work.subject === subject;
          }).map(function (item) {
            var cardWork = {
              title: _this2.getWeekTitle(item.week),
              img: item.img,
              done: item.done,
              subtitle: item.title,
              description: item.subject,
              fileUrl: item.fileUrl ? item.fileUrl : '#',
              avatarImg: _this2.defaultAvatarImg
            };
            return cardWork;
          });
        }
        ...
        key: "getWorksByWeek",
        value: function getWorksByWeek(week) {
          var _this3 = this;

          console.log(this.works);
          return this.works.filter(function (work) {
            return work.week === week;
          }).map(function (item) {
            var cardWork = {
              title: item.subject,
              img: item.img,
              ...
              description: item.subject,
              fileUrl: item.fileUrl ? item.fileUrl : '#',
              avatarImg: _this3.defaultAvatarImg
            };
            return cardWork;
          });
        }
      }, {
        key: "getWorksFromWeek",
        value: function getWorksFromWeek(id) {
          return this.works.filter(function (obj) {
            return obj.week === id;
          });
        }
      }, {
        key: "onLastPageReached",
        value: function onLastPageReached() {
          console.log('Ultima pagina alcanzada');
        }
      }, {
        key: "onPageChanges",
        value: function onPageChanges(event) {
    ...
    PageComponent.ɵfac = function PageComponent_Factory(t) {
      return new (t || PageComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["DomSanitizer"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_shared_services_firestore_service__WEBPACK_IMPORTED_MODULE_2__["FirestoreService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"]));
    };
    ...
    PageComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 45,
      vars: 5,
      consts: [[1, "getting-started"], [1, "fab", 2, "position", "fixed", "top", "10px", "right", "15px", "z-index", "100", "color", "white"], [2, "color", "white", "font-size", "larger"], ["name", "filter", "aria-label", "Font Style", 3, "value", "change"], [3, "value"], ["title", "Desarrollo - Fechas", 3, "pageChanged", "done"], ["title", "Introducci\xF3n"], [1, "mat-app-background", "basic-container", "dashboard-card-content"], [1, "card-container"], [1, "dashboard-card"], [1, "card"], [2, "flex", "1 1 auto", "font-size", "100px"], [2, "text-align", "left"], ["mat-flat-button", "", "color", "accent"], ["disabled", "true", "mat-stroked-button", "", "color", "basic"], [2, "display", "flex", "justify-content", "center"], ["src", "./assets/img/study1.jpeg", 1, "image"], [4, "ngFor", "ngForOf"], ["title", "Pr\xF3ximamente m\xE1s contenido..."], ["class", "card", 4, "ngFor", "ngForOf"], [3, "title"], [4, "ngIf"], ["fxLayout", "row", "fxLayoutAlign", "space-between", 1, "dashboard-card-content"], [3, "work"], ["src", "./assets/img/study2.jpeg", 1, "image"]],
      template: function PageComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function PageComponent_Template_mat_button_toggle_group_change_4_listener() {
            return ctx.showBySubject = !ctx.showBySubject;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("pageChanged", function PageComponent_Template_mat_pages_pageChanged_9_listener($event) {
            return ctx.onPageChanges($event);
          })("done", function PageComponent_Template_mat_pages_done_9_listener() {
            return ctx.onLastPageReached();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](25, "Click aqu\xED...");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](40, " Conclusi\xF3n ");
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](PageComponent, [{
        ...
        return [{
          ...
          type: _shared_services_firestore_service__WEBPACK_IMPORTED_MODULE_2__["FirestoreService"]
        }, {
  ...
  /***/
  function srcAppWorksWorksRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "WorksRoutingModule", function () {
      return WorksRoutingModule;
    });
    /* harmony import */
    ...
    var WorksRoutingModule = function WorksRoutingModule() {
      _classCallCheck(this, WorksRoutingModule);
    };

    WorksRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: WorksRoutingModule
    });
    WorksRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function WorksRoutingModule_Factory(t) {
        return new (t || WorksRoutingModule)();
      },
      imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](WorksRoutingModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](WorksRoutingModule, [{
  ...
  /***/
  function srcAppWorksWorksModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "WorksModule", function () {
      return WorksModule;
    });
    /* harmony import */
    ...
    var _works_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./works-routing.module */
    "./src/app/works/works-routing.module.ts");
    /* harmony import */


    var _components_page_page_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./components/page/page.component */
    "./src/app/works/components/page/page.component.ts");
    /* harmony import */


    var _angular_material_extensions_pages__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! @angular-material-extensions/pages */
    "./node_modules/@angular-material-extensions/pages/__ivy_ngcc__/fesm2015/angular-material-extensions-pages.js");
    /* harmony import */
    ...
    var WorksModule = function WorksModule() {
      _classCallCheck(this, WorksModule);
    };

    WorksModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: WorksModule
    });
    WorksModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function WorksModule_Factory(t) {
        return new (t || WorksModule)();
      },
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _works_routing_module__WEBPACK_IMPORTED_MODULE_2__["WorksRoutingModule"], _material_material_module__WEBPACK_IMPORTED_MODULE_5__["MaterialModule"], _angular_material_extensions_pages__WEBPACK_IMPORTED_MODULE_4__["MatPagesModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_6__["SharedModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](WorksModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](WorksModule, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"],
        args: [{
          declarations: [_components_page_page_component__WEBPACK_IMPORTED_MODULE_3__["PageComponent"]],
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _works_routing_module__WEBPACK_IMPORTED_MODULE_2__["WorksRoutingModule"], _material_material_module__WEBPACK_IMPORTED_MODULE_5__["MaterialModule"], _angular_material_extensions_pages__WEBPACK_IMPORTED_MODULE_4__["MatPagesModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_6__["SharedModule"]]
...
//# sourceMappingURL=works-works-module-es5.js.map